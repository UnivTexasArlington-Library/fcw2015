...
$year = 2014;
include("../db.php");
//CTRLF all architecture and replace with college name
...
?>
	...
	<div id="rightnav">
	<ul id="nav">
	<div id="topTitle" class="depttitle"><?php echo $college_name; ?></div><li class="current architecture_nav"><a href="#topcollege" id="top"></a></li>
	<div id="facultyTitle" class="depttitle">Architecture</div><li class="architecture_nav"><a href="#architecture_departments" id="faculty"></a></li>
	</ul>
	...
	<div class="row" id="main">
      ...
      <div id="architecture_col">
      </div>
	<section id="topcollege">
		<div class="row">
			<h1 class='architecture collegehome'><?php echo $college_name; ?></h1>
	    </div>
	</section>
	...
	<?php 
				...
				echo '<section id="architecture_departments" data-speed="4" data-type="background">';
				echo "<div class='row main-architecture'><div class='col-xs-11'>";
				echo "<div class='depthead'>";
				echo "<div class='depttop'>";
				echo "<h2 class='hidden-xs hidden-sm'>Architecture</h2>";
  ...
  <script>
  	...
  	<script>
   		$(document).ready(function(){
	   		...
	   		$("#architecture_departments").css("min-height", inner);
	   		$("#architecture_departments").each(function() {
...
/*$.fn.scrollStopped = function(callback) {           
    ...
    $(window).scrollStopped(function() {
    	var winwidth = $(window).width();
    		if (winwidth < 799) {
	    		$(".depttitle").css("display", "none");
    		}
	    	});*/
$(window).bind("resize scrollStopped", function() {
	    		$('.viewmore').remove();
   	...
   	$("#faculty").hover( function() {
		...
		$("#arrow").on('click', function(e) {
	   		e.preventDefault();
	   		var thishref = $('.architecture_nav.current').children('a').attr('href');
	   			if (thishref) {
