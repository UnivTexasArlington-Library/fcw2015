...
$year = 2014;
include("../db.php");
//CTRLF all liberalarts and replace with college name
...
?>
	...
	<div id="rightnav">
	<ul id="nav">
	<div id="topTitle"><?php echo $college_name; ?></div><li class="current liberalarts_nav"><a href="#topcollege" id="top"></a></li>
	</ul>
	<ul id="subnav">
	...
	<div id="criminologyTitle">Criminology and Criminal Justice</div><li class="liberalarts_nav"><a href="#19" id="criminology"></a></li>
	<div id="englishTitle">English</div><li class="liberalarts_nav"><a href="#20" id="english"></a></li>
	<div id="historyTitle">History</div><li class="liberalarts_nav"><a href="#21" id="history"></a></li>
	<div id="linguisticsTitle">Linguistics and TESOL</div><li class="liberalarts_nav"><a href="#22" id="linguistics"></a></li>
	<div id="languagesTitle">Modern Languages</div><li class="liberalarts_nav"><a href="#23" id="languages"></a></li>
	<div id="musicTitle">Music</div><li class="liberalarts_nav"><a href="#24" id="music"></a></li>
	<div id="philosophyTitle">Philosophy and Humanities</div><li class="liberalarts_nav"><a href="#25" id="philosophy"></a></li>
	<div id="polisciTitle">Political Science</div><li class="liberalarts_nav"><a href="#26" id="polisci"></a></li>
	<div id="sociologyTitle">Sociology and Anthropology</div><li class="liberalarts_nav"><a href="#27" id="sociology"></a></li>
	<div id="theatreTitle">Theatre Arts</div><li class="liberalarts_nav"><a href="#28" id="theatre"></a></li>
	...
	$stmt = $db->prepare("SELECT departments.department_id, department_name, department_chair FROM departments, faculty WHERE faculty.department_id=departments.department_id AND faculty.college_id=:id AND faculty.department_id != 36 ORDER BY department_name, faculty_last_name");
	...
	while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
		if ($row['department_id'] != $deptid) {
				echo '<section id="' . $row['department_id'] . '" class="liberalarts_departments" data-speed="4" data-type="background">';
				echo "<div class='row main-liberalarts'><div class='col-xs-11'>";
	...
	/*$stmt4 = $db->prepare("SELECT * FROM faculty, departments WHERE departments.department_id=faculty.department_id AND faculty.department_id=36 AND faculty.college_id=:id");*/
	$stmt4 = $db->prepare("SELECT * FROM faculty_items, items, faculty, departments WHERE faculty.faculty_id=faculty_items.faculty_id AND faculty.department_id=36 AND faculty.college_id=:id AND faculty_items.item_id=items.item_id and items.item_date=2014 AND departments.department_id=faculty.department_id");
	$stmt4->execute(array(":id"=>$college));
	$rowcount = $stmt4->rowCount();
	if ($rowcount > 0) {
			echo '<section id="36" class="liberalarts_departments" data-speed="4" data-type="background">';
				echo "<div class='row main-liberalarts'><div class='col-xs-11'>";
				echo "<div class='depthead'>";
				echo "<div class='depttop'>";
			echo "<h2 class='smallcol visible-xs visible-sm'>" . $college_name . "</h2>";
	...
	$("#arrow").on('click', function(e) {
   	...
   	$("#theatre").on('mouseout', function() {
   		...
   		$(document).ready(function(){
	   		...
	   		$(".liberalarts_departments").css("min-height", inner);
	   		$(".liberalarts_departments").each(function() {
   				...
   				if ((poshigh < 2) || (poswide < 3)) {
   					//console.log("poshigh is " + poshigh + "poswide is " + poswide);
   				}
   				else {
