...
$year = 2014;
include("../db.php");
//CTRLF all libraries and replace with college name
...
?>
	...
	<div id="rightnav">
	<ul id="nav">
	<div id="topTitle"><?php echo $college_name; ?></div><li class="current libraries_nav"><a href="#topcollege" id="top"></a></li>
	<div id="facultyTitle">Libraries</div><li class="libraries_nav"><a href="#libraries_departments"  id="faculty"></a></li>
	</ul>
	...
	<div class="row" id="main">
      ...
      <div id="libraries_col">
      </div>
	<section id="topcollege">
		<div class="row">
			<h1 class='libraries collegehome'><?php echo $college_name; ?></h1>
	    </div>
	</section>
	...
	<?php 
				...
				echo '<section id="libraries_departments" data-speed="4" data-type="background">';
				echo "<div class='row main-libraries'><div class='col-xs-11'>";
				echo "<div class='depthead'>";
				echo "<div class='depttop'>";
				echo "<h2 class='hidden-xs hidden-sm'>Libraries</h2>";
  ...
  <script>
   		...
   		$(document).ready(function(){
	   		...
	   		$("#libraries_departments").css("min-height", inner);
	   		$("#libraries_departments").each(function() {
 ...
 var heightoflastsection = $("section:last-of-type").height();
   	...
   	$("#faculty").hover( function() {
		...
		$("#arrow").on('click', function(e) {
	   		e.preventDefault();
	   		var thishref = $('.libraries_nav.current').children('a').attr('href');
	   			if (thishref) {
