...
$year = 2014;
include("../db.php");
//CTRLF all science and replace with college name
...
?>
	...
	<div id="rightnav">
	<ul id="nav">
	<div id="topTitle"><?php echo $college_name; ?></div><li class="current science_nav"><a href="#topcollege" id="top"></a></li>
	</ul>
	<ul id="subnav">
	<div id="biologyTitle">Biology</div><li class="science_nav"><a href="#29" id="biology"></a></li>
	<div id="chemistryTitle">Chemistry and Biochemistry</div><li class="science_nav"><a href="#30" id="chemistry"></a></li>
	<div id="earthTitle">Earth and Environmental Sciences</div><li class="science_nav"><a href="#31" id="earth"></a></li>
	<div id="mathTitle">Mathematics</div><li class="science_nav"><a href="#32" id="math"></a></li>
	<div id="physicsTitle">Physics</div><li class="science_nav"><a href="#33" id="physics"></a></li>
	<div id="psychologyTitle">Psychology</div><li class="science_nav"><a href="#34" id="psychology"></a></li>
	...
	while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
		if ($row['department_id'] != $deptid) {
				echo '<section id="' . $row['department_id'] . '" class="science_departments" data-speed="4" data-type="background">';
				echo "<div class='row main-science'><div class='col-xs-11'>";
	...
	$rowcount = $stmt4->rowCount();
	if ($rowcount > 0) {
			echo '<section id="36" class="science_departments" data-speed="4" data-type="background">';
				echo "<div class='row main-science'><div class='col-xs-11'>";
				echo "<div class='depthead'>";
				echo "<div class='depttop'>";
			echo "<h2 class='smallcol visible-xs visible-sm'>" . $college_name . "</h2>";
   ...
   <script src="../deploy/scripts/jquery.min.js"></script>
	...
	$("#arrow").on('click', function(e) {
   	...
   	<script>
   	$("#biology").hover( function() {
   		$("#biologyTitle").toggle('slide');
   	});
   	$("#chemistry").hover( function() {
   		$("#chemistryTitle").toggle('slide');
   	});
   	$("#earth").hover( function() {
   		$("#earthTitle").toggle('slide');
   	});
   	$("#math").hover( function() {
   		$("#mathTitle").toggle('slide');
   	});
   	$("#physics").hover( function() {
   		$("#physicsTitle").toggle('slide');
   	});
   	$("#psychology").hover( function() {
   		$("#psychologyTitle").toggle('slide');
   	});
   	$("#top").hover( function() {
   	...
   	$("#dean").hover( function() {
   		...
   		$(document).ready(function(){
	   		...
	   		$(".science_departments").css("min-height", inner);
	   		$(".science_departments").each(function() {
