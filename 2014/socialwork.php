...
$year = 2014;
include("../db.php");
//CTRLF all socialwork and replace with college name
...
?>
	...
	<div id="collegenav" class="hidden-table-xs hidden-table-sm">
	<div class="navtable">
	...
	<div id="rightnav">
	<ul id="nav">
	<div id="topTitle"><?php echo $college_name; ?></div><li class="current socialwork_nav"><a href="#topcollege" id="top"></a></li>
	<div id="facultyTitle">Social Work</div><li class="socialwork_nav"><a href="#socialwork_departments"  id="faculty"></a></li>
	</ul>
	...
	<div class="row" id="main">
      ...
      <div id="socialwork_col">
      </div>
	<section id="topcollege">
		<div class="row">
			<h1 class='socialwork collegehome'><?php echo $college_name; ?></h1>
	    </div>
	</section>
	...
	<?php 
				...
				echo '<section id="socialwork_departments" data-speed="4" data-type="background">';
				echo "<div class='row main-socialwork'><div class='col-xs-11'>";
				echo "<div class='depthead'>";
				echo "<div class='depttop'>";
				echo "<h2 class='hidden-xs hidden-sm'>Social Work</h2>";
  ...
  <script>
   		...
   		$(document).ready(function(){
	   		...
	   		$("#socialwork_departments").css("min-height", inner);
	   		$("#socialwork_departments").each(function() {
...
$(window).bind("resize scrollStop", function() {
   	...
   	$("#faculty").hover( function() {
		...
		$("#arrow").on('click', function(e) {
	   		e.preventDefault();
	   		var thishref = $('.socialwork_nav.current').children('a').attr('href');
	   			if (thishref) {
